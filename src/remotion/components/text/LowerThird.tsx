...
export const LowerThird: React.FC<LowerThirdProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 28, fontFamily, fontWeight: 700, color: textColor, lineHeight: 1.2 }}>
          {name}
        </div>
        {title && (
          <div style={{ fontSize: 18, fontFamily, fontWeight: 400, color: accentColor, marginTop: 4, lineHeight: 1.2 }}>
            {title}
          </div>
        )}
      </div>
