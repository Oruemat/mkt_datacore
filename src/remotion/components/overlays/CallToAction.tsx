...
export const CallToAction: React.FC<CallToActionProps> = ({
  text,
  subtext,
  backgroundColor = `${DC_BRAND.colors.blue600}ee`,
  textColor = "#ffffff",
  accentColor = DC_BRAND.colors.blue100,
    ...
    >
      <div
        style={{
          ...
          boxShadow: `0 8px 32px rgba(0,0,0,0.15), 0 0 40px rgba(37, 99, 235, 0.2)`,
        }}
      >
        <div style={{ fontSize: 28, fontFamily, fontWeight: 700, color: textColor }}>
          {text}
        </div>
        {subtext && (
          <div style={{ fontSize: 18, fontFamily, fontWeight: 400, color: accentColor, marginTop: 6 }}>
            {subtext}
          </div>
        )}
      </div>
